  ...
  <div class="rsea-box">
    ...
    <div class="res-content">
      ...
      <el-row class="res-content-line">
        ...
        <el-col :span="7">
          <div class="res-input">
            <el-date-picker clear-icon :editable="false"  v-model="searchinfo.create_end" value-format="yyyy-MM-dd" type="date" placeholder="选择日期">
            </el-date-picker>
          </div>
        </el-col>
        <el-col :span="4"><div class="res-btn" @click="searchFn"><span>确定</span></div></el-col>
...
<script>
  export default {
    ...
    methods:{
      ...
      searchFn(){
        let data = {
          min_balance: this.searchinfo.min_balance,
          max_balance: this.searchinfo.max_balance,
          create_start: this.searchinfo.create_start,
          create_end:  this.searchinfo.create_end
        };
        //执行父组件方法
        this.$emit('tievent',data,'');
      }
