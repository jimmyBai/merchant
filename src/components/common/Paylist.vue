  ...
  <div class="ws-content">
    <div class="listtable">
      ...
      <el-table stripe :data="ListData">
        ...
        <el-table-column prop="seat_num" label="积分"></el-table-column>
        <el-table-column prop="takeout_num" label="余额"></el-table-column>
    ...
    methods:{
      getlistData(){
        let vm =this,url='/api/web/order/list',params={
          ...
          "type": "3",      //订单类型 1[外卖] 2[订座] 3[店铺消费] 4[直播会员]
          "search": {
            "order_sn": ""
          },
          "page": "1",
